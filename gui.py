...
class GUI(object):
    ...
    def __init__(self, img_size=(350, 350), selected_color='cornflower blue',
        ...
        self.color1 = 'LightBlue1'
        self.color2 = 'SteelBlue1'
        self.color3 = 'SlateBlue3'
        self.color4 = 'MediumOrchid1'
        self.color5 = 'violet red'

        """self.color1 = 'IndianRed1'
        self.color2 = 'dark orange'
        self.color3 = 'goldenrod3'
        self.color4 = 'sea green'
        self.color5 = 'navy'"""
    ...
    def render_images(self, images):
        ...
        """
        standard = self.img_size[1]
        img_size = (standard*10, standard)
        #print(type(img_size), standard)
        ...
        def img_command(idx):
            ...
            """
            #click시 숫자 증가
            if self.img_status[idx] >= 5:
                self.img_status[idx] = 5
            else:
                self.img_status[idx] += 1

            # click시 색상 변화
            if self.img_status[idx] == 1:
                color = self.color1
            elif self.img_status[idx] == 2:
                color = self.color2
            elif self.img_status[idx] == 3:
                color = self.color3
            elif self.img_status[idx] == 4:
                color = self.color4
            elif self.img_status[idx] == 5:
                color = self.color5
            else:
    ...
    def render(self, images, sample=None):
...
class GUI_initialization(object):
    def __init__(self, img_size=(200, 200), selected_color='cornflower blue',
                 unselected_color='floral white', **kwargs):
        """Initialized a GUI object.
    ...
    def render_init(self, images):
        ...
        self.root.state('zoomed')
        self.root.title('Preference Selection')
    ...
    def render_text(self):
        ...
        text_box.tag_configure('center', justify='center')
        text_box.insert('1.0', 'Select the Preference')
        text_box.tag_add('center', '1.0', 'end')
        text_box.pack(fill='both', expand=False, side='top')
